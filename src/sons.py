...
class SoundEffect:
    def __init__(self):
        ...
        self.sounds = {
            ...
            'game over': pygame.mixer.Sound("sons/game over.mp3"),
            'marche': pygame.mixer.Sound("sons/marche.mp3"),
            'soin': pygame.mixer.Sound("sons/soin.mp3"),
            'tire': pygame.mixer.Sound("sons/tire.mp3"),
            'victoir': pygame.mixer.Sound("sons/victoir.mp3"),
            'fond': pygame.mixer.Sound("sons/fond.mp3"),
            'fondforet': pygame.mixer.Sound("sons/fondforet.mp3"),
        }
